...
def main():
    ...
    parser.description = "MLDSL Language Server ({0})".format(__version__)
    parser.add_argument(
    ...
    if args.debug_parser:
        ...
        if args.debug_rootpath:
            config_path = os.path.join(args.debug_rootpath, ".mldslls")
            ...
            if config_exists:
                try:
                    ...
                    print("Error while parsing '.mldslls' settings file")
